package tech.luochan.study.adapter;
...
//        gInterceptors.put("phoneModel", new DemoInterceptor());
        gInterceptors.put( Build.MODEL, new DemoInterceptor());
    }
    ...
    static class DemoInterceptor extends Interceptor {
        ...
        public boolean systemPhoneCalling() {
            Timber.d("system phone calling .....");
            return super.systemPhoneCalling();
        }

        @Override
        public boolean beforeRunConnectTask() {
            Timber.d("before run connect task...");
            return super.beforeRunConnectTask();
        }

        @Override
        public boolean beforeConnectBluetoothProfile() {
            Timber.d("before connect bluetooth profile");
            return super.beforeConnectBluetoothProfile();
        }

        @Override
        public boolean beforeConnect(AudioDevice audioDevice) {
            Timber.d("before connect");
